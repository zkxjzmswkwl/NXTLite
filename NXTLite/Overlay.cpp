...
void Overlay::StatTrackWindow()
{
    ...
    if (skillTree != nullptr)
    {
        ...
        ImGui::Text("Woodcutting\n\tLevel: %i\n\tEXP: %i", skillTree->woodcutting.curLevel, skillTree->woodcutting.totalExp);
    }
    else
    {
        skillTree = loadSkills((uintptr_t)GetModuleHandleA("rs2client.exe"));
    }
    ImGui::End();
}
